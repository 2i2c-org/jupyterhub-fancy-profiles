...
test("Combobox opens and highlights first item on arrow up", async () => {
  ...
  expect(field.getAttribute("aria-activedescendant")).toEqual("combobox-listbox-0");
});
...
test("Combobox opens and highlights last item on arrow down", async () => {
  ...
  expect(field.getAttribute("aria-activedescendant")).toEqual("combobox-listbox-3");
});
...
test("Combobox navigates through listbox items", async () => {
  ...
  expect(field.getAttribute("aria-activedescendant")).toEqual("combobox-listbox-0");
  await user.type(field, "{ArrowDown}");
  expect(field.getAttribute("aria-activedescendant")).toEqual("combobox-listbox-1");
